defmodule SBoM.Cyclonedx.V17.Event do
  ...
  field(:source, 5, proto3_optional: true, type: SBoM.Cyclonedx.V17.ResourceReferenceChoice)
  field(:target, 6, proto3_optional: true, type: SBoM.Cyclonedx.V17.ResourceReferenceChoice)
