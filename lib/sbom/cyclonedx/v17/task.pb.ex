defmodule SBoM.CycloneDX.V17.Task do
  ...
  field(:taskTypes, 7, repeated: true, type: SBoM.CycloneDX.V17.TaskType, enum: true)
  field(:trigger, 8, proto3_optional: true, type: SBoM.CycloneDX.V17.Trigger)
