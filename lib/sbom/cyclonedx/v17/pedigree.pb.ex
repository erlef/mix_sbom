defmodule SBoM.Cyclonedx.V17.Pedigree do
  ...
  field(:ancestors, 1, repeated: true, type: SBoM.Cyclonedx.V17.Component)
  field(:descendants, 2, repeated: true, type: SBoM.Cyclonedx.V17.Component)
  field(:variants, 3, repeated: true, type: SBoM.Cyclonedx.V17.Component)
