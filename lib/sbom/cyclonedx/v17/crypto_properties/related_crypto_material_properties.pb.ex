defmodule SBoM.Cyclonedx.V17.CryptoProperties.RelatedCryptoMaterialProperties do
  ...
  field(:creationDate, 5, proto3_optional: true, type: Google.Protobuf.Timestamp)
  field(:activationDate, 6, proto3_optional: true, type: Google.Protobuf.Timestamp)
  field(:updateDate, 7, proto3_optional: true, type: Google.Protobuf.Timestamp)
  field(:expirationDate, 8, proto3_optional: true, type: Google.Protobuf.Timestamp)
  ...
  field(:securedBy, 12,
    proto3_optional: true,
    type:
      SBoM.Cyclonedx.V17.CryptoProperties.RelatedCryptoMaterialProperties.CryptoRelatedSecuredBy
  )
