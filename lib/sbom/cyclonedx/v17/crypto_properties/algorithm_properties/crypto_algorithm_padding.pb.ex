defmodule SBoM.CycloneDX.V17.CryptoProperties.AlgorithmProperties.CryptoAlgorithmPadding do
  @moduledoc """
  Padding
  """
  ...
  use Protobuf,
    enum: true,
    full_name: "cyclonedx.v1_7.CryptoProperties.AlgorithmProperties.CryptoAlgorithmPadding",
