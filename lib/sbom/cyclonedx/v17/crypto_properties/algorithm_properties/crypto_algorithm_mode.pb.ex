defmodule SBoM.CycloneDX.V17.CryptoProperties.AlgorithmProperties.CryptoAlgorithmMode do
  @moduledoc """
  Mode
  """
  ...
  use Protobuf,
    enum: true,
    full_name: "cyclonedx.v1_7.CryptoProperties.AlgorithmProperties.CryptoAlgorithmMode",
