defmodule SBoM.CycloneDX.V17.CryptoProperties.AlgorithmProperties.CryptoPrimitive do
  @moduledoc """
  Primitive
  """
  ...
  use Protobuf,
    enum: true,
    full_name: "cyclonedx.v1_7.CryptoProperties.AlgorithmProperties.CryptoPrimitive",
  ...
  field(:CRYPTO_PRIMITIVE_KEY_WRAP, 16)
end
