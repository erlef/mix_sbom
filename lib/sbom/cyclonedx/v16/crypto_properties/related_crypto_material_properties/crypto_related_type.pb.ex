defmodule SBoM.CycloneDX.V16.CryptoProperties.RelatedCryptoMaterialProperties.CryptoRelatedType do
  @moduledoc """
  ...
  use Protobuf,
    enum: true,
    full_name: "cyclonedx.v1_6.CryptoProperties.RelatedCryptoMaterialProperties.CryptoRelatedType",
