defmodule SBoM.CycloneDX.V16.CryptoProperties.RelatedCryptoMaterialProperties.CryptoRelatedState do
  @moduledoc """
  State
  """
  ...
  use Protobuf,
    enum: true,
    full_name: "cyclonedx.v1_6.CryptoProperties.RelatedCryptoMaterialProperties.CryptoRelatedState",
