defmodule SBoM.CycloneDX.V16.ReleaseNotes do
  @moduledoc "CycloneDX ReleaseNotes model."
  use Protobuf,
    full_name: "cyclonedx.v1_6.ReleaseNotes",
  ...
  field(:resolves, 9, repeated: true, type: SBoM.CycloneDX.V16.Issue)
  field(:notes, 10, repeated: true, type: SBoM.CycloneDX.V16.Note)
  field(:properties, 11, repeated: true, type: SBoM.CycloneDX.V16.Property)
end
