defmodule SBoM.CycloneDX.V16.ModelCard do
  @moduledoc """
  *
  ...
  use Protobuf,
    full_name: "cyclonedx.v1_6.ModelCard",
  ...
  field(:modelParameters, 2,
    ...
    type: SBoM.CycloneDX.V16.ModelCard.ModelParameters
  )

  field(:quantitativeAnalysis, 3,
    proto3_optional: true,
    type: SBoM.CycloneDX.V16.ModelCard.QuantitativeAnalysis
  )

  field(:considerations, 4,
    proto3_optional: true,
    type: SBoM.CycloneDX.V16.ModelCard.ModelCardConsiderations
  )
end
