defmodule SBoM.CycloneDX.V16.Licensing do
  @moduledoc "CycloneDX Licensing model."
  use Protobuf,
    full_name: "cyclonedx.v1_6.Licensing",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3

  alias Google.Protobuf.Timestamp
  alias SBoM.CycloneDX.V16.OrganizationalEntityOrContact
  ...
  field(:licenseTypes, 6, repeated: true, type: SBoM.CycloneDX.V16.LicensingTypeEnum, enum: true)
