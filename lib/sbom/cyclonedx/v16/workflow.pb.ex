defmodule SBoM.CycloneDX.V16.Workflow do
  @moduledoc """
  A specialized orchestration task.
  """

  use Protobuf,
    full_name: "cyclonedx.v1_6.Workflow",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3

  alias Google.Protobuf.Timestamp
  alias SBoM.CycloneDX.V16.Dependency
  ...
  field(:tasks, 7, repeated: true, type: SBoM.CycloneDX.V16.Task)
  field(:taskDependencies, 8, repeated: true, type: Dependency)
  field(:taskTypes, 9, repeated: true, type: SBoM.CycloneDX.V16.TaskType, enum: true)
  field(:trigger, 10, proto3_optional: true, type: SBoM.CycloneDX.V16.Trigger)
  field(:steps, 11, repeated: true, type: SBoM.CycloneDX.V16.Step)
  field(:inputs, 12, repeated: true, type: SBoM.CycloneDX.V16.InputType)
  field(:outputs, 13, repeated: true, type: SBoM.CycloneDX.V16.OutputType)
